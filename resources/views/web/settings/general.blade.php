<div class="max-w-lg pt-6 mx-auto">
    ...
    <div class="w-full px-6 pt-4 pb-8 space-y-4 bg-white">
        <x-input name="site-name" label="Název administrace" placeholder="Webdo stránka"/>
        <x-input name="site-name" label="URL adresa frontendu" placeholder="https://webdostranka.cz"/>
    </div>
</div>
