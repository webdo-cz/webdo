<div>
    ...
    <div class="mb-4 bg-white">
        @foreach ($orders as $key => $order)
            <button wire:click="showOrder({{ $order->id }})" class="px-4 py-4 w-full sm:px-6 hover:bg-light-blue-500 hover:text-white {{ $loop->first ? '' : 'border-t' }}">
