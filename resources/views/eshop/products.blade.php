<div>
    ...
    <div class="space-y-3">
        @foreach($products as $key => $product)
            <div wire:key="{{ $product->id }}" class="flex bg-white">
                <a href="{{ url('eshop/products/edit-record/' . $product->id) }}" class="flex flex-col justify-between flex-grow w-2/3 px-4 py-4 text-sm font-medium leading-5 text-gray-800 transition duration-200 cursor-pointer md:items-center md:flex-row sm:px-6 hover:text-light-blue-500">
